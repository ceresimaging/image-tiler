...
router
  .get("/:z/:x/:y.png", validateTile, validateSize, createMap, gssurgoLayer, zoomBox, rasterResponse, respond)
  .get("/:z/:x/:y.mvt", validateTile, validateSize, createMap, gssurgoLayer, vectorResponse, respond);
