...
describe("tree routes", () => {
  test("should return a vector tile with trees", async () => {
    ...
    const res = await request
      .get(`/${base}/count/${overlay}/15/5337/12656.mvt`)
  ...
  test("should return a raster tile with trees", async () => {
    ...
    const res = await request.get(
      `/${base}/count/${overlay}/15/5337/12656.png`
    );
  ...
  test("should return a raster image with trees filtered by varietal", async () => {
    const overlay = "041cfc7f-fd9e-4dc5-bf91-0d3775dcce1b";

    const res = await request.get(
      `/${base}/count/${overlay}.png?varietal=Nonpareil&varietal=Aldrich`
    );
  ...
  test("should return a vector tile with tree data", async () => {
    ...
    const res = await request
      .get(`/${base}/data/${overlay}/15/5337/12656.mvt`)
      .responseType("arraybuffer");
  ...
  test("should return a raster image with tree data filtered by color", async () => {
    ...
    const res = await request.get(
      `/${base}/data/${overlay}.png?color=%23ff0101&color=%230101ff`
    );
